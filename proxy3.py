...
from SocketServer import ThreadingMixIn	#?????? user defined ?????
...
#valid_client_message = False		#	TODO:	we could possibly run into race conditions with this variable.....**********

# # will be parsed from 'client_message'
#client_requested_host = ''			#	TODO:	we could possibly run into race conditions with this variable.....**********
...
class ClientThread(Thread):
	...
	def run(self):
		...
		while valid_client_message == False:
			...
			print "client thread executed run method"
...
out_sock = socket(AF_INET, SOCK_STREAM) 			#	TODO:	this will probably need to be declared inside of thread, not globally
...
client_sock.bind(('localhost', listen_port))
...
print 'right after accept'

#dedicated_con_sock, (ip,port) = client_sock.accept()	
#print 'Got connection from ', (ip,port)
#newClientThread = ClientThread(ip,port,dedicated_con_sock)      #call __init__ (constructor)????
